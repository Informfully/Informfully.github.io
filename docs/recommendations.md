...
This page provides information on how to populate the [recommendationLists` `data collection](./database.md) in the back end and based on [user and item data](./compass.md).
The [relevant code](https://github.com/Informfully/Documentation/tree/main/sample) is shared separately.
...
Again, you can use the [reference implementation](https://github.com/Informfully/Documentation/tree/main/sample) mentioned above to turn the user-item recommendations into JREX.
