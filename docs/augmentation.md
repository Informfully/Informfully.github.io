...
For the code, please see the [augmentation folder](https://github.com/Informfully/Recommenders/tree/main/cornac/augmentation) in the repository.
...
[Implementation available online.](https://github.com/Informfully/Recommenders/tree/main/cornac/augmentation/sentiment.py)
...
[Implementation available online.](https://github.com/Informfully/Recommenders/tree/main/cornac/augmentation/enrich_ne.py)
...
[Implementation available online.](https://github.com/Informfully/Recommenders/tree/main/cornac/augmentation/readability.py)
...
[Implementation available online.](https://github.com/Informfully/Recommenders/tree/main/cornac/augmentation/story.py)
...
A pre-trained zero-shot classifier, [bart-large-mnli](https://huggingface.co/facebook/bart-large-mnli), stored locally and downloaded from [Hugging Face](https://huggingface.co), can be used to analyze the item's text and assign the most suitable category.
...
[Implementation available online.](https://github.com/Informfully/Recommenders/tree/main/cornac/augmentation/category.py)
