...
* [Apple App Store (for iOS devices, version 13.0 and newer)](https://apps.apple.com/ch/app/ddis-news/id1460234202)

::: info

Theoretically, the mobile app should be compatible with devices running iOS 11.0.
However, [TestFlight](https://developer.apple.com/testflight/) (which was used for testing the beta version of the app) is only supported by devices with a minimum iOS 13.0.
...
If not, make sure to install everything listed in the [Installation Instructions](./install.md).
...
Make sure to install [react-native-cli` and follow the `native code getting started guide for React Native](https://reactnative.dev/docs/getting-started).
...
See the [ejecting guide](https://docs.expo.dev/expokit/eject/) for more details about this option.

Once these steps have been completed, you are ready to create your first release.
We have more detailed instructions for [Android released](./google.md) and [iOS releases](./apple.md).
...
An ejected app will require you to have an [XCode and/or Android Studio environment](https://reactnative.dev/docs/environment-setup)) set up.

:::

## Deploy Website

Please see the other instruction page for [Website Deployment](./deployment.md).
If you already have the website up and running, go ahead and start your first [Use Experiment](./experiment.md).
